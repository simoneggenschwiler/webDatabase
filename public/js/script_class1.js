...
async function ready() {
    ...
    const res = await fetch(path_json+'alleles_classI_common.json')
    const data = await res.json()
    loadBody(data);


    const res_phos = await fetch(path_json+'alleles_classI_phospho.json')
...
const path_classI = 'data/classI/'

const Models = [
    {
        nameID: 'MixMHCpred', nameShown: 'Model', sourceFolderLogos: path_classI + 'MixMHCpred', sourceLendist: path_classI + 'MS'
    },
    {
        nameID: 'MSData', nameShown: 'Ligands', sourceFolderLogos: path_classI + 'MS', sourceLendist: ''
    },
    {
        nameID: 'MultSpec', nameShown: 'Multiple Specificities', 'sourceFolderLogos': path_classI + 'MS', sourceLendist: ''
    }
]
...
const PTMModels = [{
    nameID: 'phospho', nameShown: 'Phosphorylated Ligands', sourceFolderLogos: path_classI + 'phospho'
}]
